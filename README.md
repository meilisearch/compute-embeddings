...
```bash
cat file.json | ce-dataset --batched-documents 8 --documents-style meilisearch name description brand categories _type object_id > file-with-embeddings.json
```
...
```bash
cat file.json | ce-dataset --batched-documents 8 --documents-style qdrant name description brand categories _type object_id > file-with-embeddings.json
```
